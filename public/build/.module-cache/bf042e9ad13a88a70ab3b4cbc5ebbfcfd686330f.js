...
var DaysContainer = React.createClass({displayName: "DaysContainer",
	...
	render: function () {
		...
		return React.DOM.ul({className:"days-container flex-container"}, days);
...
var DaysOfMonth = React.createClass({displayName: "DaysOfMonth",
	render: function () {
		...
		return (React.createElement("li", {className: classes, "data-longDate": thi.prop.longDate}, this.prop.shortDate))
	}
});
